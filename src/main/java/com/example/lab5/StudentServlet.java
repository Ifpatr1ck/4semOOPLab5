...
public class StudentServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String INSERT_NEW = "INSERT INTO students (name, lastname, age, `group`, telephone_number) VALUES (?, ?, ?, ?, ?)";
        try {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{
            ...
            while(resultSet.next()){
                out.println("<tbody> <tr><td>" + resultSet.getString("name") + "</td><td>" + resultSet.getString("lastname") + "</td><td>" + resultSet.getInt("age") + "</td><td>" + resultSet.getString("group") + "</td><td>" + resultSet.getInt("telephone_number") + "</td>");
                Student student = new Student(resultSet.getString("name"), resultSet.getString("lastname"), resultSet.getInt("age"), resultSet.getString("group"), resultSet.getInt("telephone_number"));
